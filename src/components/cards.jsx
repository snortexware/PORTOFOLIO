...
export default function Cards1() {
  ...
  return (
    <div
      id="projects"
      className="relative grid grid-cols-1 sm:grid-cols-1 flex justify-center  w-[300px] md:w-[900px] mt-8 md:mt-0 mx-auto"
    >
      ...
      <div
        style={{}}
        className=" gap-4 items-center justify-center grid grid-cols-1 sm:grid-cols-2 "
      >
        <ScrollRevealWrapper duration={1.1}>
          <Card className=" h-[250px] bg-[#162268]  rounded-lg shadow-lg transition duration-500  hover:translate-y-[-5px] hover:shadow-xl">
            <CardHeader className="justify-between">
              ...
              <div className="flex gap-5">
                <FaGithub style={{ width: "20px", height: "20px" }}></FaGithub>
        ...
        <ScrollRevealWrapper width={"100vh"} duration={1.2}>
          <Card className=" h-[250px]  bg-[#162268]  rounded-lg shadow-lg transition-transform duration-1000 ease-in-out hover:translate-y-[-5px] hover:shadow-xl">
            ...
            <CardBody className="px-3 py-0 text-small text-gray-300">
              <p>
                Um sistema de fechamento de atendimento automatico para Sistema
                de chat Whatsapp MegaZap feito com a biblioteca Selenium em
                Node.js, analisando o atendimento e fechando/transferindo de
                acordo com a tag aplicada pelo atendente.
              </p>
            </CardBody>
            <CardFooter className="gap-4">
              <Typography
        ...
        <ScrollRevealWrapper width={"100vh"} duration={1.4}>
          <Card className=" h-[250px]  bg-[#162268]  rounded-lg shadow-lg transition-transform duration-1000 ease-in-out hover:translate-y-[-5px] hover:shadow-xl">
            <CardHeader className="justify-between">
              ...
              <div className="flex gap-5">
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/snortexware/PORTOFOLIO"
                >
                  <TfiNewWindow style={{ width: "20px", height: "20px" }} />
                </a>
              </div>
            ...
            <CardBody className="px-3 py-0 text-small text-gray-300">
              <p>
                Este portfólio foi criado com React, Vite e Tailwind CSS,
                oferecendo uma experiência rápida e moderna. O React deixa o
                site interativo e fácil de usar, o Vite acelera o
                desenvolvimento, e o Tailwind ajuda a criar um visual elegante e
                responsivo.
              </p>
            </CardBody>
            <CardFooter className="gap-4">
